...
#define PC_BOARD_ID "PC_BOARD_ID"
#define PC_BOARD_CHIP "PC_BOARD_CHIP"
#define PC_BOARD_CHIP_FAMILY "PC_BOARD_CHIP_FAMILY"
#define EMBEDDED
//#define FAKE_STDLIB
...
#define os_printf jsiConsolePrintf
